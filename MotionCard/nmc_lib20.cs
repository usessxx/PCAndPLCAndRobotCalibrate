...
namespace csNMCLib20
{
    public class NMCLib20
    {
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_LoadConfigFromFile(HAND devHandle, string pFilePath);
        ...
        public struct TAxisStsPack12Ex
        {
            ...
            public TAxisStsPack12Ex(bool bInit)
            {
                mtSts = new short[12];
                mtMio = new short[12];
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_CrdEllipse(HAND crdHandle, int segNo, double abRatio, int[] pCenterPos, short ellipseDir, double vel, double synAcc);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_CrdCircle3DEx(HAND crdHandle, long segNo, Int32[] pMidPos, Int32[] pTgPos, double velEnd, double vel, double synAcc, Int16 lookaheadDis);
        ...
        public struct TCrdBufDO
        {
            ...
            public long value;     // 输出值,取值范围[0,1]
        };

        public struct TCrdBufDelay
        {
            public long segNo;     // 用户自定义段号
            public long scale;     // 延时单位,0表示单位为毫秒,1表示单位为秒
            public long count;     // 延时时长
        };

        public struct TCrdBufDOEx
        {
            public long segNo;     // 用户自定义段号
            public long group;    // 缓冲区输出DO组
            public long doMask;    // 输出操作位,bit位为1表示要输出
            public long value;     // 输出值,bit位指示输出值
        };
        ...
        {
            public long segNo;        // 用户自定义段号
            public long onDelay;     // 开光延时
            public long offDelay;     // 关光延时
            public long minValue;     // 最小输出值
            public long maxValue;     // 最大输出值
            public long standbyPower;	// 待机能量
        ...
        {
            public long segNo;			// 用户自定义段号
            public long highLevelTime;	// 高电平宽度，单位:us
            public long lowLevelTime;	// 低电平宽度，单位:us
            public long outCount;		// 输出脉冲个数
            public long initialLevel;	// 0：先输出低电平，1：先输出高电平
            public short ch;			// ch:通道
        ...
        {
            public long segNo;			// 用户自定义段号
            public long minFrq;        // 最小频率，仅当enable=1时有效
            public short ch;			// 通道
        ...
        {
            public long segNo;			// 用户自定义段号
            public long axisMask;		// 轴掩码
            public long overTime;		// 等待超时时间，单位：毫秒
        };
        ...
        public struct TCrdBufWaitDI
        {
            ...
            public long waitLastTime;  //超时,单位：毫秒
        };
        ...
        /// <summary>
        /// 急设置坐标系剩余位移量，用于控制激光能量跟随后的关闭波形输出
        /// </summary>
        /// <param name="crdHandle">坐标系句柄</param>
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_CrdSetLeftLenForLaserWaveOff(HAND crdHandle, double length);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_MtSetLeadScrewCompPara(HAND axisHandle, Int16 num, Int32 startPos, Int32 cmpLen, Int16[] pCompPos, Int16[] pCompNeg);
        ...
        // DI type
        public const Int32 DI_TYPE_LIMIT_POSITIVE = 0;  // 正向限位
        public const Int32 DI_TYPE_LIMIT_NEGATIVE = 1;  // 负向限位
        public const Int32 DI_TYPE_ALARM = 2; // 驱动报警
        public const Int32 DI_TYPE_HOME = 3;  // 原点
        public const Int32 DI_TYPE_GPI = 4;  // 通用输入
        public const Int32 DI_TYPE_LIMIT_POSITIVE_LOG = 10; // 正向限位:逻辑电平
        public const Int32 DI_TYPE_LIMIT_NEGATIVE_LOG = 11;  // 负向限位:逻辑电平
        public const Int32 DI_TYPE_ALARM_LOG = 12;  // 驱动报警:逻辑电平
        public const Int32 DI_TYPE_HOME_LOG = 13;  // 原点:逻辑电平
        /// <summary>
        /// 读各类输入
        /// </summary>
        ...
        /// <param name="pDiValue"></param>
        /// <returns></returns>

        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_GetDIEx(HAND devHandle, short diType, short groupID, ref int pDiValue);
        /// <summary>
        /// 获取数字量输入信号的翻转计数
        /// </summary>
        /// <param name="devHandle"></param>
        /// <param name="diType">DI类型</param>
        /// <param name="diIndex">DI序号，取值范围[0,n]</param>
        /// <param name="pReverseCountArray">翻转计数数组</param>
        /// <param name="count">同时获取的数量，取值范围[1,16]</param>
        /// <returns></returns>

        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_GetDiReverseCount(HAND devHandle, short diType, short diIndex, ref uint[] pReverseCountArray, short count);
        ...
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_SetDiReverseCount(HAND devHandle, short diType, short diIndex, ref uint[] pReverseCountArray, short count);

        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_GetAdcVoltageMulti(HAND devHandle, short ch, short count, ref double[] pAdcVolArray);
        ...
        public struct TComp2DimensParamEx
        {
            ...
            public short outputChn;                            // 比较输出的通道号，取值[0,n]
            public short outputType;                           // 输出方式0：脉冲1：电平
            public short chnType;                              // 通道类型：0 GPO, 1  GATE通道
            public short dir1No;                               // 方向1 的位置源轴号（0~11）
            public short dir2No;                               // 方向2 的位置源轴号（0~11）
            public short posSrc;                               // 轴位置类型 ：0规划1：编码器
            public short stLevel;                              // 电平模式下的起始电平（0或1）
            public short errZone;                              // 进入比较点容差半径范围（pulse）
            public short directOutZone;                        // 近距离直接触发范围
        ...
        /// <param name="group">组号,0 或者1</param>
        /// <param name="param">参数结构体</param>
        /// <param name="chn">保留,设为0</param>
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_Comp2DimensSetParamEx(HAND devHandle, Int16 group, ref TComp2DimensParamEx param, Int16 chn);
        /// <summary>
        /// 功能：读取2维位置比较的参数(简洁版)
        /// </summary>
        /// <param name="devHandle">设备句柄</param>
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_Comp2DimensGetParamEx(HAND devHandle, Int16 group, ref TComp2DimensParamEx param, Int16 chn);
        /// <summary>
        /// 设置二维比较数据
        /// </summary>
        /// <param name="devHandle">控制器句柄</param>
        ...
        public struct TComp2DimensSts
        {
            ...
            public int reserved2;		// 保留
            public int reserved3;		// 保留
            public int reserved4;		// 保留
            public int reserved5;		// 保留
        }
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_Comp2DimensStatusEx(HAND devHandle, short group, ref TComp2DimensSts pStatus, short chn);
        //----------------------------------------------------------
        //	结构体初始化函数
        //----------------------------------------------------------
        ...
        public struct TMvProtectPara
        {
            ...
            public long orgDis;         // 两坐标系的crdAxNo轴在原点时的距离
            public long mvProtectDis;    // 干涉的保护距离   
            public long safeWaitPos;    // mode为激光模式时，干涉轴需要停止到的等待位置（mode为0时无效）
        ...
        public struct TAutoRtnPackedSts
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
            public long[] mtPrfPos;       // 单轴规划位置
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
            public long[] mtEncPos;       // 单轴实际位置
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 12)]
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public long[] crdUserSeg;      // 坐标系运行的缓冲区段号
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public long[] crdFreeSpace;    // 坐标系缓冲区剩余空间
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public long[] crdUsedSpace;    // 坐标系缓冲区使用空间

            public long gpi;                // 通用输入
            public long gpo;                // 通用输出
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
            public Int16[] reserved;       // 预留

            public TAutoRtnPackedSts(bool init)
            {
                mtSts = new Int16[12];
                mtMio = new Int16[12];
                mtPrfPos = new long[12];
                mtEncPos = new long[12];
                mtPrfVel = new float[12];

                crdSts = new Int16[2];
                crdPrfVel = new float[2];
                crdUserSeg = new long[2];
                crdFreeSpace = new long[2];
                crdUsedSpace = new long[2];
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_DevAutoRtnSet(HAND devHandle, long mode1, long mode2, long cycleInMs, long port, long hostTag);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_DevAutoRtnSyn(HAND devHandle, long hostTag);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_MtSetPtpComparePara(HAND axisHandle, short dir, long comparaPos, double upDateVel);
        ...
        /// /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_DevAsynAbsMoveType1(HAND axisHandle, float acc, float dec, float vel, short smooth, long arrivalBand, long stableTime, long tgtPos);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_MtFollowStart(HAND axisHandle, short syncAxCnts, ref short pSyncAxArray);
        ...
        /// <returns></returns>
        [DllImport(DLL_PATH, CallingConvention = CallingConvention.StdCall)]
        public static extern Int16 NMC_MtFollowSwitch(HAND axisHandle, short syncAxCnts, ref short pSyncAxArray);
