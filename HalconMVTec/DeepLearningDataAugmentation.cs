...
{
    public class DeepLearningDataAugmentation
    {
        #region DLDataAugmentationAction
        public void DLDataAugmentationAction(HTuple hv_dict, HTuple hv_images_fotmat, HTuple hv_imags_fill, HTuple hv_WindowHandle, HTuple hv_data_enhanced, out HTuple hv_dict_copy)
        {
