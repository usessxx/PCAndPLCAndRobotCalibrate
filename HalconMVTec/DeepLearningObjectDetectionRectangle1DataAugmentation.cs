...
{
    public class DeepLearningObjectDetectionRectangle1DataAugmentation
    {
        #region DLObjectDetectionRectangle1DataAugmentationAction
        public void DLObjectDetectionRectangle1DataAugmentationAction(HTuple hv_dict, HTuple hv_images_fotmat, HTuple hv_imags_fill, HTuple hv_WindowHandle, HTuple hv_data_enhanced, out HTuple hv_dict_copy)
        {
            ...
            HTuple hv_bbox_row1 = new HTuple(), hv_bbox_col1 = new HTuple();
            HTuple hv_bbox_row2 = new HTuple(), hv_bbox_col2 = new HTuple();
            HTuple hv_lable_width = new HTuple(), hv_lable_height = new HTuple();
            HTuple hv_Width = new HTuple(), hv_Height = new HTuple();
            HTuple hv_samples_sub_Original = new HTuple(), hv_new_row1 = new HTuple();
            HTuple hv_new_row2 = new HTuple(), hv_samples_sub_Row = new HTuple();
            HTuple hv_new_col1 = new HTuple(), hv_new_col2 = new HTuple();
            ...
            try
            {
                ...
                for (hv_Index = 0; hv_Index.Continue(end_val46, step_val46); hv_Index = hv_Index.TupleAdd(step_val46))
                {
                    ...
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.GetDictTuple(hv_samples.TupleSelect(hv_Index), "bbox_row1",
                            out hv_bbox_row1);
                    }
                    //获得'bbox_col1'
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.GetDictTuple(hv_samples.TupleSelect(hv_Index), "bbox_col1",
                            out hv_bbox_col1);
                    }
                    //获得'bbox_row2'
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.GetDictTuple(hv_samples.TupleSelect(hv_Index), "bbox_row2",
                            out hv_bbox_row2);
                    }
                    //获得'bbox_col2'
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        ...
                        HOperatorSet.GetDictTuple(hv_samples.TupleSelect(hv_Index), "bbox_col2",
                            out hv_bbox_col2);
                    }

                    //获得标注框的宽和高
                    hv_lable_width.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_lable_width = hv_bbox_col2 - hv_bbox_col1;
                    }
                    hv_lable_height.Dispose();
                    using (HDevDisposeHelper dh = new HDevDisposeHelper())
                    {
                        hv_lable_height = hv_bbox_row2 - hv_bbox_row1;
                    }
                    ...
                    if ((int)(new HTuple(hv_data_enhanced.TupleGreater(1))) != 0)
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_new_row1 = (hv_Height - hv_bbox_row1) - hv_lable_height;
                        }
                        hv_new_row2.Dispose();
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_new_row2 = (hv_Height - hv_bbox_row2) + hv_lable_height;
                        }
                        //更新改动的数据
                        //把samples[Index]写入
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        ...
                        //更新'bbox_row1'
                        HOperatorSet.SetDictTuple(hv_samples_sub_Row, "bbox_row1", hv_new_row1);
                        //更新'bbox_row2'
                        HOperatorSet.SetDictTuple(hv_samples_sub_Row, "bbox_row2", hv_new_row2);
                        //更新到samples_copy
                        if (hv_samples_copy == null)
                            hv_samples_copy = new HTuple();
                    ...
                    if ((int)(new HTuple(hv_data_enhanced.TupleGreater(2))) != 0)
                    {
                        ...
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_new_col1 = (hv_Width - hv_bbox_col1) - hv_lable_width;
                        }
                        hv_new_col2.Dispose();
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        {
                            hv_new_col2 = (hv_Width - hv_bbox_col2) + hv_lable_width;
                        }
                        //更新改动的数据
                        //把samples[Index]写入
                        using (HDevDisposeHelper dh = new HDevDisposeHelper())
                        ...
                        //更新'bbox_row1'
                        HOperatorSet.SetDictTuple(hv_samples_sub_Col, "bbox_col1", hv_new_col1);
                        //更新'bbox_row2'
                        HOperatorSet.SetDictTuple(hv_samples_sub_Col, "bbox_col2", hv_new_col2);
                        //更新到samples_copy
                        if (hv_samples_copy == null)
                            hv_samples_copy = new HTuple();
                    ...
                    if ((int)(new HTuple(hv_data_enhanced.TupleGreater(3))) != 0)
                    {
                        ...
                        //更新'bbox_row1'
                        HOperatorSet.SetDictTuple(hv_samples_sub_RC, "bbox_row1", hv_new_row1);
                        //更新'bbox_row2'
                        HOperatorSet.SetDictTuple(hv_samples_sub_RC, "bbox_row2", hv_new_row2);
                        //更新'bbox_row1'
                        HOperatorSet.SetDictTuple(hv_samples_sub_RC, "bbox_col1", hv_new_col1);
                        //更新'bbox_row2'
                        HOperatorSet.SetDictTuple(hv_samples_sub_RC, "bbox_col2", hv_new_col2);
                        //更新到samples_copy
                        if (hv_samples_copy == null)
                            hv_samples_copy = new HTuple();
